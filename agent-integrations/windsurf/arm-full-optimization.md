<!-- Place this prompt file at .windsurf/workflows/performance-advanced.md in the workspace root to enable it.
     Invoke using /performance-advanced in the cascade chat.
-->
